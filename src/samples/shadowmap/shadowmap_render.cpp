...
void SimpleShadowmapRender::AllocateResources()
{
  ...
  bigImage = m_context->createImage(etna::Image::CreateInfo{
    .extent     = vk::Extent3D{ m_width * scale, m_height * scale, 1 },
    .name       = "BigImage",
...
void SimpleShadowmapRender::loadShaders()
{
  ...
  etna::create_program("SSAA", 
      { VK_GRAPHICS_BASIC_ROOT "/resources/shaders/quad.frag.spv", VK_GRAPHICS_BASIC_ROOT "/resources/shaders/quad3_vert.vert.spv" });
}
...
void SimpleShadowmapRender::SetupSimplePipeline()
{
  ...
  m_pBindings->BindImage(0, bigImage.getView({}), linearSampler.get(), VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
  ...
  m_SSAAPipeline = pipelineManager.createGraphicsPipeline("SSAA",
...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  //
  {
    etna::RenderTargetState renderTargets(a_cmdBuff, {2048 * scale, 2048 * scale}, {}, shadowMap);
  ...
  //
  {
    ...
    etna::RenderTargetState renderTargets(a_cmdBuff, {m_width * scale, m_height * scale}, {{bigImage}}, mainViewDepth);
