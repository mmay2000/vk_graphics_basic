...
void SimpleShadowmapRender::loadShaders()
{
  ...
  etna::create_program("tone_mapping",
    { VK_GRAPHICS_BASIC_ROOT "/resources/shaders/tone_mapping.frag.spv", VK_GRAPHICS_BASIC_ROOT "/resources/shaders/quad3_vert.vert.spv" });
}
...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  {
    auto simpleToneMappingInfo = etna::get_shader_program("tone_mapping");

    auto set = etna::create_descriptor_set(simpleToneMappingInfo.getDescriptorLayoutId(0), a_cmdBuff, 
        { etna::Binding{ 0, constants.genBinding() }, 
        etna::Binding{ 1, HDRImage.genBinding(defaultSampler.get(), 
    ...
    vkCmdBindDescriptorSets(a_cmdBuff, VK_PIPELINE_BIND_POINT_GRAPHICS, m_toneMappingPipeline.getVkPipelineLayout(),
