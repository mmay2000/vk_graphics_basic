...
void SimpleShadowmapRender::BuildCommandBufferSimple(VkCommandBuffer a_cmdBuff, VkImage a_targetImage, VkImageView a_targetImageView)
{
  ...
  //
  {
    ...
    auto set = etna::create_descriptor_set(simpleMaterialInfo.getDescriptorLayoutId(0), {
      ...
      etna::Binding {3, vk::DescriptorImageInfo {defaultSampler.get(), gNorms.getView({}), vk::ImageLayout::eShaderReadOnlyOptimal}},
      etna::Binding {4, vk::DescriptorImageInfo {defaultSampler.get(), gAlbedoSpec.getView({}), vk::ImageLayout::eShaderReadOnlyOptimal}}
    });
